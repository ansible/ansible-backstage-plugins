...
| [`aap-oauth-authentication.mmd`](aap-oauth-authentication.mmd)                         | Full AAP OAuth2 + PKCE authentication lifecycle — login, token exchange, profile fetch, sign-in resolution, token refresh, and logout                      |
