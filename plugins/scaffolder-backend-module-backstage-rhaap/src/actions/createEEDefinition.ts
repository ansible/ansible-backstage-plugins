...
export function createEEDefinitionAction(options: {
  ...
  return createTemplateAction({
    ...
    schema: {
      ...
      output: {
        contextDirName: schema => schema.string().optional(),
        generatedEntityRef: schema => schema.string().optional(),
        owner: schema => schema.string().optional(),
        catalogInfoPath: schema => schema.string().optional(),
        readmeContent: schema => schema.string().optional(),
        eeDefinitionContent: schema => schema.string().optional(),
        mcpVarsContent: schema => schema.string().optional(),
      },
    },
    async handler(ctx) {
