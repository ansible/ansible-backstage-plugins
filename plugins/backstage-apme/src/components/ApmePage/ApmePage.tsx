...
export const ApmePage = () => {
  ...
  const {
    ...
    if (!enabled) {
      return { health: null, projects: [] as Project[] };
    }
  ...
  const handleDeleteConfirm = useCallback(async () => {
    ...
    setDeleteError(null);
    try {
      await apmeApi.deleteProject(pendingDeleteId);
    ...
    },
    {
      ...
      render: row => (
        <Tooltip title="Remove from APME">
          <IconButton size="small" onClick={e => handleDeleteClick(e, row.id)}>
    ...
    <Page themeId="tool">
      ...
      <Content>
        ...
        >
          ...
          <DialogContent>
            <Typography>
              Remove this project from APME tracking? Scan history will be
              deleted.
            </Typography>
          </DialogContent>
          <DialogActions>
