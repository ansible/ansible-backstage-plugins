    ...
    layout: [
      {
        ...
        labels: {
          ...
          totalVulnerabilities: 'Unique CVEs',
          fixable: 'Fixable',
          unfixable: 'No Fix Available',
          hostsAffected: 'Hosts Affected',
        },
      },
      {
        widget: 'severity_breakdown',
        group_by: 'severity',
        labels: { CAT_I: 'Critical / High', CAT_II: 'Medium', CAT_III: 'Low' },
      },
      {
        widget: 'action_table',
...
const SC_RULES = [
  {
    ruleId: 'CVE-2026-28439',
    stigId: 'openssl',
    title: 'openssl 3.0.7-27.el9 — CVE-2026-28439',
    category: '',
    severity: 'CAT_I',
    disruption: 'low',
    checkText: 'CVSS: Critical',
    fixText: 'Update to openssl-3.0.7-28.el9 via `dnf update openssl`',
  },
  {
    ruleId: 'CVE-2026-31852',
    stigId: 'curl',
    title: 'curl 7.76.1-26.el9 — CVE-2026-31852',
    category: '',
    severity: 'CAT_I',
    disruption: 'low',
    checkText: 'CVSS: High',
    fixText: 'Update to curl-7.76.1-29.el9 via `dnf update curl`',
  },
  {
    ruleId: 'CVE-2026-22105',
    stigId: 'glibc',
    title: 'glibc 2.34-83.el9 — CVE-2026-22105',
    category: '',
    severity: 'CAT_II',
    disruption: 'low',
    checkText: 'CVSS: Medium',
    fixText: 'Update to glibc-2.34-85.el9 via `dnf update glibc`',
  },
  {
    ruleId: 'CVE-2026-19477',
    stigId: 'python3',
    title: 'python3 3.9.18-3.el9 — CVE-2026-19477',
    category: '',
    severity: 'CAT_II',
    disruption: 'low',
    checkText: 'CVSS: Medium',
    fixText: 'Update to python3-3.9.18-5.el9 via `dnf update python3`',
  },
  {
    ruleId: 'CVE-2026-40891',
    stigId: 'vim-minimal',
    title: 'vim-minimal 9.0.2081-2.el9 — CVE-2026-40891',
    category: '',
    severity: 'CAT_III',
    disruption: 'low',
    checkText: 'CVSS: Low',
    fixText: 'No fix available for vim-minimal. Monitor for vendor updates.',
  },
];
...
function nextFindingId(): string {
  return `mock-finding-${++_findingCounter}`;
}
function resetFindingCounter(): void {
  _findingCounter = 0;
}

function stigFindings(
  scanId: string,
  states: Record<string, { status: string; state: string | null }>,
): FindingRow[] {
  ...
  for (const rule of STIG_RULES) {
    ...
    for (const host of HOSTS) {
      ...
      rows.push({
        ...
        evidence: null,
        finding_state:
          override?.state ?? (defaultStatus === 'fail' ? 'active' : null),
      });
    }
  }
  return rows;
...
function scFindings(scanId: string): FindingRow[] {
  ...
  > = {
    ...
    'CVE-2026-31852': {
      ...
      state: 'new',
      fixState: 'fix_available',
      installed: '7.76.1-26.el9',
      fixed: '7.76.1-29.el9',
      cvss: 8.1,
    },
    'CVE-2026-22105': {
      hosts: ['web-prod-05', 'app-prod-01', 'app-prod-02'],
      state: 'active',
      fixState: 'fix_available',
      installed: '2.34-83.el9',
      fixed: '2.34-85.el9',
      cvss: 6.5,
    },
    'CVE-2026-19477': {
      hosts: ['db-prod-03', 'db-prod-04'],
      state: 'resurfaced',
      fixState: 'fix_available',
      installed: '3.9.18-3.el9',
      fixed: '3.9.18-5.el9',
      cvss: 5.3,
    },
    'CVE-2026-40891': {
...
export class MockDataSeeder {
  ...
  private async seedProfiles(): Promise<void> {
    ...
    const profiles = [
      {
        id: 'rhel9-stig',
        profile_slug: 'rhel9-stig',
        display_name: 'DISA STIG for RHEL 9',
        framework: 'DISA_STIG',
        version: 'V2R8',
        description:
        ...
        remediate_jt_id: 103,
        ee_id: 1,
        remediation_playbook_path: 'playbooks/remediate.yml',
        scan_tags: '',
        rule_count: 366,
        connection_status: 'connected',
        profile_version: 'V2R8',
        connected_at: now,
      ...
      {
        id: 'rhel9-cis-l1',
        profile_slug: 'rhel9-cis-l1',
        display_name: 'CIS Benchmark RHEL 9 — Level 1 Server',
        framework: 'CIS',
        version: '1.0.0',
        ...
        workflow_template_id: 102,
        remediate_jt_id: null,
        ee_id: 1,
        remediation_playbook_path: '',
        scan_tags: '',
        rule_count: 189,
        connection_status: 'connected',
      ...
      {
        id: 'rhel9-pci-dss',
        profile_slug: 'rhel9-pci-dss',
        display_name: 'PCI-DSS v4.0 for RHEL 9',
        framework: 'PCI_DSS',
        version: '4.0',
        description:
      ...
      },
      {
        ...
        profile_slug: 'supply-chain-vuln',
        display_name: 'Supply Chain Vulnerability Scan',
  ...
  private async seedRuleMetadata(): Promise<void> {
    const allRules = [
      ...
      ...SC_RULES.map(r => ({
        ...
        check_text: r.checkText,
        fix_text: r.fixText,
        category: r.category || 'Package Vulnerability',
        disruption: r.disruption,
        scanner: 'syft-grype',
        aap_impact: 'safe',
        aap_impact_reason: '',
  ...
  private async seedScans(): Promise<void> {
    const scHostsMeta = Object.fromEntries(
      HOSTS.map((h, i) => [
        h,
        {
          totalScannedPackages: 412,
          totalVulnerablePackages: (i % 5) + 1,
    ...
    const scans = [
      {
        ...
        status: 'completed',
        started_at: ago(25),
        completed_at: ago(25, -1),
        scan_metadata: JSON.stringify({
          hosts: Object.fromEntries(HOSTS.map(h => [h, {}])),
        }),
      },
      {
        id: 'mock-scan-stig-prod-002',
        profile_id: 'rhel9-stig',
        inventory_id: 1,
        scanner: 'oscap',
        scan_type: 'assessment',
        ...
        status: 'completed',
        started_at: ago(0, 2),
        completed_at: ago(0, 1),
        scan_metadata: JSON.stringify({
          hosts: Object.fromEntries(HOSTS.map(h => [h, {}])),
        }),
      },
      {
        id: 'mock-scan-cis-staging-001',
        profile_id: 'rhel9-cis-l1',
        inventory_id: 2,
        scanner: 'oscap',
        scan_type: 'assessment',
      ...
      {
        id: 'mock-scan-pci-prod-001',
        profile_id: 'rhel9-pci-dss',
        inventory_id: 1,
        scanner: 'oscap',
        scan_type: 'assessment',
      ...
      {
        id: 'mock-scan-sc-prod-001',
        profile_id: 'supply-chain-vuln',
        inventory_id: 1,
        scanner: 'syft-grype',
        scan_type: 'assessment',
        workflow_job_id: 1005,
        status: 'completed',
        started_at: ago(1),
        completed_at: ago(1, -1),
        scan_metadata: JSON.stringify({
          hosts: scHostsMeta,
          totalScannedPackages: 8240,
          totalVulnerablePackages: 50,
          totalVulnerabilities: 5,
        }),
      },
      {
        id: 'mock-scan-sc-prod-002',
        profile_id: 'supply-chain-vuln',
        inventory_id: 1,
        scanner: 'syft-grype',
        scan_type: 'assessment',
        workflow_job_id: 1006,
        status: 'completed',
        started_at: ago(0, 4),
        completed_at: ago(0, 3),
        scan_metadata: JSON.stringify({
          hosts: scHostsMeta,
          totalScannedPackages: 8240,
          totalVulnerablePackages: 50,
      ...
      {
        id: 'mock-scan-stig-dev-001',
        profile_id: 'rhel9-stig',
        inventory_id: 3,
        scanner: 'oscap',
        scan_type: 'assessment',
        workflow_job_id: 1007,
        status: 'completed',
        started_at: ago(3),
        completed_at: ago(3, -1),
        scan_metadata: null,
      ...
      {
        id: 'mock-scan-verify-001',
        profile_id: 'rhel9-stig',
        inventory_id: 1,
        scanner: 'oscap',
        scan_type: 'assessment',
        workflow_job_id: 1008,
        status: 'completed',
        started_at: ago(0, 1),
        completed_at: ago(0, 0),
        scan_metadata: JSON.stringify({
          hosts: Object.fromEntries(HOSTS.map(h => [h, {}])),
        }),
      },
    ...
    const snapshots = [
      {
        ...
        profile_id: 'rhel9-stig',
        inventory_id: 1,
        scan_id: 'mock-scan-stig-prod-001',
      ...
      // STIG on dev inventory
      {
        ...
        profile_id: 'rhel9-stig',
        inventory_id: 3,
        scan_id: 'mock-scan-stig-dev-001',
        timestamp: new Date(now - 3 * day).toISOString(),
        total_hosts: 20,
        total_rules: 366,
        pass_count: 227,
      ...
      // CIS
      {
        ...
        profile_id: 'rhel9-cis-l1',
        inventory_id: 2,
        scan_id: 'mock-scan-cis-staging-001',
        timestamp: new Date(now - 1 * day).toISOString(),
        total_hosts: 20,
        total_rules: 189,
        pass_count: 160,
  ...
  private async seedRemediationProfiles(): Promise<void> {
    const profiles = [
      {
        id: 'mock-rp-stig-phase1',
        name: 'STIG Baseline — Phase 1',
        description:
          'First phase of STIG hardening: SSH, auditd, and basic config rules.',
        profile_id: 'rhel9-stig',
        creation_scan_id: 'mock-scan-stig-prod-001',
        selections_json: stigSelections(8),
        status: 'saved',
      ...
      {
        id: 'mock-rp-stig-ssh',
        name: 'SSH Hardening Quick Fix',
        description: 'Quick fix for SSH-related findings only.',
        profile_id: 'rhel9-stig',
        creation_scan_id: 'mock-scan-stig-prod-002',
        selections_json: stigSelections(2),
        status: 'saved',
        created_by: 'mock-user',
        created_at: ago(5),
        updated_at: ago(5),
      ...
      {
        id: 'mock-rp-sc-patch',
        name: 'Supply Chain Patch Plan',
        description: 'Patch openssl, curl, and glibc vulnerabilities.',
        profile_id: 'supply-chain-vuln',
        creation_scan_id: 'mock-scan-sc-prod-002',
        selections_json: scSelections(),
        status: 'draft',
        created_by: 'mock-user',
        created_at: ago(0, 3),
        updated_at: ago(0, 3),
    ...
    const executions = [
      {
        ...
        plan_summary: JSON.stringify({
          ...
          groups: [
            {
              hosts: ['db-prod-03', 'app-prod-05'],
              ruleCount: 2,
              rules: ['sshd_set_idle_timeout', 'accounts_tmout'],
            },
            {
              hosts: ['web-prod-03', 'db-prod-01', 'db-prod-02'],
              ruleCount: 1,
              rules: ['sshd_disable_root_login'],
            },
          ],
        }),
    ...
    const artifacts = [
      {
        ...
        oci_reference:
          'mock://pah.example.com/compliance/supply-chain-vuln/mock-scan-sc-prod-002:sbom-web-prod-01',
      ...
      },
      {
        ...
        oci_reference:
          'mock://pah.example.com/compliance/supply-chain-vuln/mock-scan-sc-prod-002:sbom-db-prod-01',
