import {
  ...
  `;
      ...
      expect(result!.baseImageName).toBe('registry.redhat.io/ee-minimal-rhel8:2.18');
    });
  ...
  `;
      ...
      expect(result!.collections[0]).toEqual({ name: 'cisco.nxos', version: '2.0.0' });
      expect(result!.collections[1]).toEqual({ name: 'amazon.aws', version: undefined });
    });
