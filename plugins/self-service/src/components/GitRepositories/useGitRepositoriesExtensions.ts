 ...
 * NotImplementedError until a factory is on the host — so portal-only /
 * Extensions-lab (APME not installed) crash the page. Look up optionally
 * and fall back to the ADR-010 empty default.
 */
