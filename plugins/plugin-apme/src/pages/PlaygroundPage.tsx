          ...
          <CardContent>
            <Box
              ...
              style={{
                ...
                textAlign: 'center',
                cursor: 'pointer',
                background: isDragOver ? 'rgba(25,118,210,0.05)' : undefined,
                transition: 'all 0.2s',
              }}
            >
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={4}>
                  ...
                  <input
                    ...
                    placeholder="e.g. ansible.builtin"
                    style={{
                      width: '100%',
                      padding: '6px 8px',
                      borderRadius: 4,
      ...
      <Card>
        <CardContent>
          ...
          <Typography variant="body2">
            {tier1.patches.length} patches applied, {tier1.format_diffs.length}{' '}
            format changes
          </Typography>
    ...
    <Card>
      <CardContent style={{ textAlign: 'center' }}>
        ...
        <Box mt={2} display="flex" justifyContent="center" style={{ gap: 8 }}>
          {patchedFiles.size > 0 && (
            ...
            >
              {downloading
                ? 'Preparing...'
                : `Download Remediated Files (${patchedFiles.size})`}
            </Button>
          )}
          <Button
            variant="outlined"
        ...
        {remaining > 0 && (
          <Box
            mt={2}
            style={{ textAlign: 'left', maxWidth: 700, margin: '16px auto 0' }}
          >
            <Button
              size="small"
              ...
              endIcon={
                <ExpandMoreIcon
                  style={{
                    transform: showRemaining ? 'rotate(180deg)' : undefined,
                  }}
                />
              }
            >
